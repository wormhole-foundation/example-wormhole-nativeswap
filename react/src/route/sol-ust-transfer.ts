...
import { SOL_UST_TOKEN_INFO } from "../utils/consts";
import { RouterCore } from "./generic";

export const PROTOCOL = "SolUstTransfer";

const UST_DECIMALS = 6;

const UST_AMOUNT_MULTIPLIER = "1000000";

export class SolUstTransfer extends RouterCore {
  computePoolAddress(): string {
    return SOL_UST_TOKEN_INFO.address;
  }
